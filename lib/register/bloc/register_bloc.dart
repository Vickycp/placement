...
import 'package:placement/validators.dart';
...
class RegisterBloc extends Bloc<RegisterEvent, RegisterState> {
  ...
  Stream<RegisterState> mapEventToState(
    ...
    if (event is RegisterEmailChanged) {
      ...
      yield* _mapRegisterSubmittedToState(event.email, event.password,event.usn,event.firstname,event.lastname,event.cgpa,event.dob);
    }
  }
